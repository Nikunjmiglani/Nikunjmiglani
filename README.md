...
- Cybersecurity: exploitation labs, SOC/SIEM detection engineering, OSINT foundations
...
## 📌 Current Focus
- Offensive + defensive security skill progression with a live SOC lab environment
